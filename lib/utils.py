...
def draw_curves_embedding(train_log, val_log, root):
    ...
    # plot total loss
    plt.plot(range(epochs), train_log['total_loss'], label="train_loss")
    plt.plot(range(epochs), val_log['total_loss'], label="val_loss")
    plt.xlabel('epoch')
    ...
    plt.subplot(2, 1, 1)
    plt.plot(range(epochs), train_log['walker_loss_tst'], label="train_walker_loss_tst")
    plt.plot(range(epochs), val_log['walker_loss_tst'], label="val_walker_loss_tst")
    plt.xlabel('epoch')
    plt.ylabel('walker_loss_tst')
    plt.xticks(range(1, epochs + 1))
    plt.legend()
    plt.subplot(2, 1, 2)
    plt.plot(range(epochs), train_log['walker_loss_sts'], label="train_walker_loss_sts")
    plt.plot(range(epochs), val_log['walker_loss_sts'], label="val_walker_loss_sts")
    plt.xlabel('epoch')
    ...
    fig.set_size_inches(16,16)
    plt.subplot(2, 1, 1)
    plt.plot(range(epochs), train_log['visit_loss_ts'], label="train_visit_loss_ts")
    plt.plot(range(epochs), val_log['visit_loss_ts'], label="val_visit_loss_ts")
    plt.xlabel('epoch')
    plt.ylabel('visit_loss_ts')
    plt.xticks(range(1, epochs + 1))
    plt.legend()
    plt.subplot(2, 1, 2)
    plt.plot(range(epochs), train_log['visit_loss_st'], label="train_visit_loss_st")
    plt.plot(range(epochs), val_log['visit_loss_st'], label="val_visit_loss_st")
    plt.xlabel('epoch')
    ...
    fig.set_size_inches(16,16)
    plt.subplot(2, 1, 1)
    plt.plot(range(epochs), train_log['metric_loss_st'], label="train_metric_loss_st")
    plt.plot(range(epochs), val_log['metric_loss_st'], label="val_metric_loss_st")
    plt.xlabel('epoch')
    plt.ylabel('metric_loss_st')
    plt.xticks(range(1, epochs + 1))
    plt.legend()
    plt.subplot(2, 1, 2)
    plt.plot(range(epochs), train_log['metric_loss_tt'], label="train_metric_loss_tt")
    plt.plot(range(epochs), val_log['metric_loss_tt'], label="val_metric_loss_tt")
    plt.xlabel('epoch')
    ...
    fig.set_size_inches(16,16)
    plt.subplot(2, 1, 1)
    plt.plot(range(epochs), train_log['shape_norm_penalty'], label="train_shape_norm_penalty")
    plt.plot(range(epochs), val_log['shape_norm_penalty'], label="val_shape_norm_penalty")
    plt.xlabel('epoch')
    plt.ylabel('shape_norm_penalty')
    plt.xticks(range(1, epochs + 1))
    plt.legend()
    plt.subplot(2, 1, 2)
    plt.plot(range(epochs), train_log['text_norm_penalty'], label="train_text_norm_penalty")
    plt.plot(range(epochs), val_log['text_norm_penalty'], label="val_text_norm_penalty")
    plt.xlabel('epoch')
