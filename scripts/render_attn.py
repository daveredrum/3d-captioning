...
def render(root):
    assert os.path.exists(os.path.join(root, "vis"))
    file_list = os.listdir(os.path.join(root, "vis"))
    for file_idx, file_name in enumerate(file_list):
        for i in range(2):
            if os.path.exists(os.path.join(root, "vis", file_name, "{}.png".format(i))):
                ...
                _ = subprocess.call(
                    ["sstk/ssc/render-voxels.js", "--input", os.path.join(root, "vis", "{}/{}.nrrd".format(file_name, i))], 
