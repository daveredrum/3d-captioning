...
def apply_attn(model_id, raw_mask):
    ...
    # attended[0][spatial_mask != 0] = readdata[0][spatial_mask != 0]
    # attended[1][spatial_mask != 0] = readdata[1][spatial_mask != 0]
    # attended[2][spatial_mask != 0] = readdata[2][spatial_mask != 0]
    # attended[3][spatial_mask != 0] = readdata[3][spatial_mask != 0]
...
def filter_attn(model_ids, attn_masks):
    ...
    for i in range(len(model_ids)):
        ...
        if applied_1[:3].max() != 0 and applied_2[:3].max() != 0:
            ...
            print("selected self-attention mask for: {}".format(model_ids[i]))
        
        else:
            print("abandoned self-attention mask for: {}".format(model_ids[i]))
...
def main(args):
    ...
    # report
    print("\nsaved self-attention masks:", len(filtered_mask_list))
    print("abandoned self-attention masks:", len(dataset) - len(filtered_mask_list))
