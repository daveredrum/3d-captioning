...
def main(args):
    ...
    dataset = EmbeddingCaptionDataset(
    ...
    for idx in range(num):
        ...
        for i, (model_ids, _, _, _, embeddings_interm, _) in enumerate(dataloader):
            if i == idx:
        ...
        for i in range(len(pairs)):
            ...
            attention = pairs[i][2].data.cpu().numpy().reshape(4, 4, 4)
            nrrd.write("outputs/vis/{}/{}/{}_{}.nrrd".format(dir_name, outname, outname, i), attention)
